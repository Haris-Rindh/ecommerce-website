...
const Suppliers = () => {
    return (
        <div className='mx-auto mt-6 mb-10 max-w-[1180px]'>
            <h3 className='text-2xl font-semibold text-gray-900 pb-6'>Suppliers by region</h3>

            <div className="grid grid-cols-5 gap-y-[24px] gap-x-[18px]">
...
function SupplierCard({ Flag, Name, Link }) {
    return (
        <div className=' w-[221px] h-[36px]  flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer'>
